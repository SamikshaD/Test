...
public final class VehicleIdentifierConstants {
	
	private VehicleIdentifierConstants(){}
	...
	public static final String VEHICLE_TYPE_BIG_WHEEL = "Big Wheel";
	public static final String FRAME_TYPE_PLASTIC = "plastic";
}
